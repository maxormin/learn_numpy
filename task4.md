...
* [学习](#学习)
  ...
  * [解方程和逆矩阵](#解方程和逆矩阵)
    ...
    * [求解线性方程组](#求解线性方程组)
* [练习](#练习)
  * [计算数组间欧式距离](#计算两个数组a和数组b之间的欧氏距离)
  * [计算矩阵的行列式和矩阵的逆](#计算矩阵的行列式和矩阵的逆)
  * [解线性方程组](#给定矩阵A和数组b，求解线性方程组)
  * [计算矩阵A特征值与特征向量](#给定矩阵A计算特征值和特征向量)
...
a = np.diag([5,5,5,5,5])
#计算矩阵行列式
print(np.linalg.det(a)) #3124.999999999999
#计算矩阵的逆
...
print(a) #[3. 6. 1.]
print(b)
# [[-8.16496581e-01 -5.77350269e-01  3.14018492e-17]
